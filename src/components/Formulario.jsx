...
const Formulario = ({cliente, cargando}) => {
    ...
    const nuevoClienteSchema = Yup.object().shape({
        nombre: Yup.string().min(3, 'El nombre es muy corto').max(20,'nombre es muy largo').required('El nombre del cliente es obligatorio'),
        ...
        >
            ...
            <Form className='mt-10'>
                ...
                <input 
                    ...
                    className='mt-5 w-full bg-blue-800 p-3 text-white uppercase font-bold text-lg cursor-pointer hover:bg-blue-500' 
                />
